    ...
    case 'rapier':
      return (
        <g className="battle-weapon-arm">
          ...
          <rect x="23.2" y="4" width="1.2" height="20" rx="0.2" fill="#d8d8e8" stroke="#aaa" strokeWidth="0.3" />
          <line x1="23.5" y1="5" x2="23.5" y2="23" stroke="rgba(255,255,255,0.3)" strokeWidth="0.3" />
          <ellipse cx="23.8" cy="14" rx="3" ry="1.8" fill="#c0c0c0" stroke="#888" strokeWidth="0.3" />
    ...
    case 'memory_blade':
      return (
        <g className="battle-weapon-arm">
          ...
          <rect x="22.5" y="6" width="2" height="18" rx="0.3" fill="rgba(147,197,253,0.6)" stroke="#60a5fa" strokeWidth="0.6" className="memory-blade-glow" />
          <rect x="22.8" y="7" width="1.4" height="16" rx="0.2" fill="rgba(255,255,255,0.3)" />
          <rect x="20" y="14" width="7" height="2.5" rx="0.8" fill="#3b82f6" stroke="#1d4ed8" strokeWidth="0.3" />
          {/* Floating particles */}
          <circle cx="22" cy="10" r="0.6" fill="#93c5fd" opacity="0.5" className="memory-blade-particle" />
          <circle cx="25.5" cy="18" r="0.5" fill="#93c5fd" opacity="0.4" className="memory-blade-particle" />
          <circle cx="21.5" cy="22" r="0.4" fill="#bfdbfe" opacity="0.3" className="memory-blade-particle" />
        </g>
      );
    default: // iron_sword, slim_sword, steel_sword, etc.
      return (
        <g className="battle-weapon-arm">
          <rect x="22.5" y="6" width="2" height="18" rx="0.3" fill="#b8b8c0" stroke="#888" strokeWidth="0.4" />
    ...
    case 'rapier':
      return (
        <g className="battle-weapon-arm">
          ...
          <rect x="24" y="10.4" width="10" height="1.2" rx="0.2" fill="#d8d8e8" stroke="#aaa" strokeWidth="0.3" />
          <line x1="25" y1="11" x2="34" y2="11" stroke="rgba(255,255,255,0.3)" strokeWidth="0.3" />
          <ellipse cx="24" cy="12.5" rx="2.5" ry="1.5" fill="#c0c0c0" stroke="#888" strokeWidth="0.3" />
    ...
    case 'memory_blade':
      return (
        <g className="battle-weapon-arm">
          ...
          <rect x="24" y="2" width="2" height="14" rx="0.3" fill="rgba(96,165,250,0.3)" stroke="rgba(96,165,250,0.2)" strokeWidth="0.4" transform="rotate(-30, 25, 9)" />
          <rect x="24" y="1" width="2" height="14" rx="0.3" fill="rgba(147,197,253,0.4)" stroke="rgba(96,165,250,0.3)" strokeWidth="0.4" transform="rotate(-25, 25, 8)" />
          <rect x="24" y="0" width="2" height="14" rx="0.3" fill="rgba(147,197,253,0.7)" stroke="#60a5fa" strokeWidth="0.6" transform="rotate(-20, 25, 7)" className="memory-blade-glow" />
          <rect x="22" y="12" width="5" height="3" rx="0.8" fill="#3b82f6" stroke="#1d4ed8" strokeWidth="0.3" />
          <circle cx="26" cy="4" r="0.5" fill="#93c5fd" opacity="0.6" className="memory-blade-particle" />
          <circle cx="28" cy="8" r="0.4" fill="#bfdbfe" opacity="0.4" className="memory-blade-particle" />
        </g>
      );
    default:
      return (
        <g className="battle-weapon-arm">
          ...
          <rect x="24" y="2" width="2" height="14" rx="0.3" fill="#b8b8c0" stroke="#888" strokeWidth="0.4" transform="rotate(-25, 25, 9)" />
          <line x1="24.5" y1="3" x2="24.5" y2="15" stroke="#e0e0e0" strokeWidth="0.4" opacity="0.5" transform="rotate(-25, 25, 9)" />
          <rect x="22" y="12" width="5" height="3" rx="0.8" fill="#d4a574" stroke="#a07850" strokeWidth="0.3" />
        </g>
      );
  }
}
  ...
  return (
    <g>
      ...
      <g transform={`translate(0, ${bodyY})`}>
        {/* Shoulder pauldrons */}
        <ellipse cx="10" cy="16" rx="2.5" ry="1.8" fill={c.dark} stroke={c.outline} strokeWidth="0.4" />
        <ellipse cx="22" cy="16" rx="2.5" ry="1.8" fill={c.dark} stroke={c.outline} strokeWidth="0.4" />
        ...
        <g transform={`translate(${hairX}, 0)`}>
          ...
          <path d="M10,10 Q10,3 14,2 L16,4 L18,2 Q22,4 22,8 L21,10 L20,7 Q17,5 13,7 L11,10 Z" fill={c.dark} />
          {/* Crown — 3 peaks */}
...
function LordWindup({ c, weaponId }: P) {
  return (
    <g>
      ...
      {/* Pauldrons */}
      <ellipse cx="10" cy="17" rx="2.5" ry="1.8" fill={c.dark} stroke={c.outline} strokeWidth="0.4" />
      <ellipse cx="21" cy="17" rx="2.5" ry="1.8" fill={c.dark} stroke={c.outline} strokeWidth="0.4" />
      {/* Body — crouched slightly */}
      <rect x="10" y="15" width="12" height="14" rx="2" fill={c.primary} stroke={c.outline} strokeWidth="0.8" />
      ...
      <path d="M9,10 Q9,3 13,2 L15,4 L17,2 Q21,4 21,8 L20,10 L19,7 Q16,5 12,7 L10,10 Z" fill={c.dark} />
      <polygon points="9.5,5.5 11.5,1 13.5,4 15,0.5 16.5,4 18.5,1 20.5,5.5" fill="#fbbf24" stroke="#b45309" strokeWidth="0.5" />
...
function LordCharge({ c, weaponId }: P) {
  return (
    <g>
      ...
      {/* Pauldrons */}
      <ellipse cx="12" cy="16" rx="2.5" ry="1.8" fill={c.dark} stroke={c.outline} strokeWidth="0.4" />
      <ellipse cx="23" cy="16" rx="2.5" ry="1.8" fill={c.dark} stroke={c.outline} strokeWidth="0.4" />
      ...
      <path d="M11,10 Q11,3 15,2 L17,4 L19,2 Q23,4 23,8 L22,10 L21,7 Q18,5 14,7 L12,10 Z" fill={c.dark} />
      <polygon points="11.5,5.5 13.5,1 15.5,4 17,0.5 18.5,4 20.5,1 22.5,5.5" fill="#fbbf24" stroke="#b45309" strokeWidth="0.5" />
      ...
      {/* Legs — running stride */}
      <rect x="8" y="27" width="4" height="8" rx="1" fill={c.dark} transform="rotate(-12, 10, 31)" />
      <rect x="20" y="24" width="4" height="10" rx="1" fill={c.dark} transform="rotate(5, 22, 29)" />
...
function LordStrike({ c, weaponId }: P) {
  return (
    <g>
      ...
      {/* Pauldrons */}
      <ellipse cx="12" cy="16" rx="2.5" ry="1.8" fill={c.dark} stroke={c.outline} strokeWidth="0.4" />
      <ellipse cx="24" cy="16" rx="2.5" ry="1.8" fill={c.dark} stroke={c.outline} strokeWidth="0.4" />
      ...
      <path d="M12,10 Q12,3 16,2 L18,4 L20,2 Q24,4 24,8 L23,10 L22,7 Q19,5 15,7 L13,10 Z" fill={c.dark} />
      <polygon points="12.5,5.5 14.5,1 16.5,4 18,0.5 19.5,4 21.5,1 23.5,5.5" fill="#fbbf24" stroke="#b45309" strokeWidth="0.5" />
