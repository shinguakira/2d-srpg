...
| Kanna | (17, 9) | Mage. Behind Shigeru. |
| Goro | (15, 7) | Fighter. Left approach. |
| Hina | (17, 10) | Cleric. Rear center. |
| Genzo | (15, 12) | Soldier. Right approach. |
| Sayo | (17, 8) | Archer. Rear left. |
| Hachi | (16, 13) | Thief. Right flank. |
| Yuki | (16, 6) | Pegasus Knight. Left flank — can bypass walls. |
| Raiga | (15, 10) | Mercenary. Forward center. |
| Mio | (17, 11) | Troubadour. Rear right. Mobile healer. |

## Enemy Forces
| Enemy | Class | Level | Position | AI | Notes |
|-------|-------|-------|----------|-----|-------|
| General Doumeki | Halberdier | 16 | (1, 10) Throne | Boss | Lance. 55 HP. Tier 2 partial awareness. Does NOT leave throne. |
| 2× Knight | Knight | 12 | (3, 9), (3, 11) | Escort | Doumeki's inner keep guards. |
...
## Objective
- Victory: Seize Doumeki's throne (Shigeru on throne after Doumeki retreats at critical HP)
...
|------|----------|--------|
| Throne | (1, 10) | +3 DEF, +10 Avoid, HP regen. Doumeki's seat. |
| Fort | (10, 7) | +2 DEF, +5 Avoid. Outer courtyard left. |
| Fort | (10, 13) | +2 DEF, +5 Avoid. Outer courtyard right. |
| Gate | (7, 9-10) | Inner keep entrance. 2 tiles wide. Main chokepoint to Doumeki. |
...
| Turn 5 | Doumeki speaks | Doumeki recognizes Akira from past cycles. Dialogue about fragments. |
...
| Doumeki at 25% HP | Doumeki's guard arrives | 2× Knight spawn from north. Fortress begins collapsing effects. |
| Doumeki at critical HP | Doumeki retreats | Doumeki escapes. Player seizes throne. |
...
| Doumeki at 25% HP | 2× Knight (Lv 12) | North edge (0, 8), (0, 12). Doumeki's personal guard. |

## Tactical Notes
- **Two-front battle**: The fortress has a clear north-to-south axis. The party pushes north toward Doumeki while reinforcements flood from the south gate at Turn 5. Akira's sacrifice solves the south problem — but only because he's fast enough to reach the chokepoint.
- **Ballista threat**: Archers at (5, 4) and (5, 16) have extended range covering the courtyard approach. Yuki can fly behind the walls to eliminate them, or the party can advance using wall tiles as cover.
...
- **Grief debuff impact**: After Turn 13, all remaining units receive -3 to all stats for 2 chapters. The Doumeki fight happens AFTER Akira falls — the player fights the boss while mechanically weakened.
- **Doumeki's retreat**: Doumeki does not die — he escapes at critical HP. This means the player must deal enough damage to trigger the retreat, not necessarily kill him. His 55 HP + throne bonuses require sustained pressure.
