...
> **Ref:** [`specs/maps/ch6.md`](specs/maps/ch6.md), [`specs/story/chapters/ch6.md`](specs/story/chapters/ch6.md), [`specs/story/characters/raiga.md`](specs/story/characters/raiga.md), [`specs/story/characters/mio.md`](specs/story/characters/mio.md)

### Config
- [x] Create chapter6.ts — 16×18 grid, objective: Boss Kill (Tsubame) + Escape south
...
### Enemies
- [x] Boss: Captain Tsubame — pegasus_knight, Lv8, steel_lance, aggressive AI, flying
...
### Recruitment
- [x] Raiga (Mercenary) joins at chapter start — add to roster
- [x] Mio (Troubadour) appears mid-chapter as green NPC ally, auto-recruits on adjacent player unit
- [x] Create Raiga unit data: Lv5, iron_sword, Mercenary class
- [x] Create Mio unit data: Lv4, heal_staff, Troubadour class, mounted

### Events
- [x] Turn 4: Mio spawns as ally NPC at south dock
- [x] Turn 8: Warning dialogue — "Reinforcements incoming, fall back!"
- [x] Turn 12: Massive reinforcement wave (escape incentive)
- [x] Tsubame defeat: dialogue about sky anomalies
...
### Enemies
- [x] Boss: Admiral Isonami (optional) — General, Lv9, steel_lance, stationary on fort
...
### Events
- [x] Turn 1: Kanna's forecast starts flickering — dialogue
- [x] Turn 3: First corrupted spawn + Kanna's crisis dialogue
- [x] Turn 6: "The system is changing the ANSWER" — Kanna's breakdown
- [x] Turn 12: Survive complete — enemies retreat, chapter ends
- [x] Optional: defeat Isonami before Turn 12 for Hero Crest
...
### Terrain
- [x] Mountain fortress, two fronts: Doumeki (north throne), reinforcements (south corridor)
...
### Enemies
- [x] Boss: General Doumeki — Halberdier (promoted soldier), Lv12, steel_lance + javelin
...
- [x] Doumeki dialogue: "I've killed you before... I remember it happening AGAIN"
- [x] After Doumeki defeat + seize: chapter end with extended epilogue

---

## Chapter 9: "The Void Left Behind" (14×14)

> **Ref:** [`specs/maps/ch9.md`](specs/maps/ch9.md), [`specs/story/chapters/ch9.md`](specs/story/chapters/ch9.md), [`specs/story/characters/kagura.md`](specs/story/characters/kagura.md)
...
### Recruitment
- [x] Kagura (Dancer) joins mid-chapter — event trigger Turn 3
- [x] Create Kagura unit data: Lv5, no weapons, Dancer class, dance innate skill
- [x] Kagura dialogue: genre-displaced (thinks this is a musical)

### Events
- [x] Chapter start: dialogue acknowledging Akira's absence
- [x] Turn 3: Kagura appears, joins party — "You all look like you need a song"
...
- [x] NPC Elder Toki at village (must survive)
- [x] Throne at hilltop (7, 1) — Sozen's position

### Enemies
- [x] Boss: General Sozen — Sage (promoted mage), Lv11, Elfire + Mend staff
  - 55 HP, boss AI, self-heals below 70% HP, drops Master Seal
- [x] 3 Coordinated guards — Lv9, escort AI protecting Sozen (reposition when one hit)
...
- [x] Elder Toki death = chapter failure (protect objective)
- [x] Sozen defeat: Master Seal reward
...
- [x] Kagura's Dance action works in ch9 (grants adjacent ally full new turn)
- [x] Dual objective in ch10 (boss kill + NPC protect — failure if Elder Toki dies)
- [x] Master Seal drops from ch10 boss (Sozen)
- [x] Roster carries forward correctly: Akira gone, Raiga/Mio/Kagura added
