# Arc 4 Story: Chapters 16-20 — "Awakening"

> **Prerequisites:** Gameplay Phase 5 (fog), Phase 6 (negotiate, multi-phase), Arc 3 Story complete
> **Spec refs:** `specs/story/chapters/ch16.md`–`ch20.md`, `specs/story/arc-structure.md`
> **Tone:** Understanding → empathy → tragic villain → commitment
> **New characters:** Ghael (conditional), Echo (conditional)
...
- [ ] "I have watched you 347 times. Each time, I hoped this would be the one."
- [ ] Party enters System's test arena: symmetrical, deliberate design

### Mid-Battle
- [ ] Test Batch waves: System commentary on party performance
...
- [ ] Fog of war warning: "We won't be able to see what's coming"
- [ ] Party splits into exploration groups

### Mid-Battle — System Origin Reveal
- [ ] Data Node Alpha capture:
...
- [ ] If Ghael killed: "At least... I die choosing..." (death quote)

### Epilogue
- [ ] Ghael recruited: veteran perspective, has seen hundreds of cycles from other side
- [ ] Legacy weapons: "These aren't just weapons. They're fragments of cycle data forged into steel."
...
- [ ] Tension: everyone knows this is the pivotal moment
...
- [ ] Multi-phase Sentinel Omega boss:
  ...
  - Phase transition: "ADAPTING COMBAT PARAMETERS"
  - Phase 2: "FINAL ASSESSMENT PROTOCOL"
...
- [ ] Multi-phase boss transition dialogue in ch20
- [ ] Tone arc: understanding (ch16-17) → empathy (ch18) → commitment (ch19-20)
