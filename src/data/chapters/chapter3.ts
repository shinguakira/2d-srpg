...
export const CHAPTER_3: ChapterData = {
  ...
  epilogue: {
    lines: [
      {
        speaker: 'Hina',
        text: 'Sayo! Now that we are comrades I have some very important questions. Favourite colour? Any brothers or sisters? Have you ever been in love?',
        speakerFaction: 'player',
      },
      ...
      { speaker: 'Sayo', text: 'We are not.', speakerFaction: 'player' },
      { speaker: 'Hina', text: 'Four! She is opening up!', speakerFaction: 'player' },
      { speaker: 'Goro', text: 'I like her. She does not waste breath.', speakerFaction: 'player' },
      {
        speaker: 'Kanna',
      ...
      effects: [
        {
          ...
          scene: {
            lines: [
              ...
              { speaker: 'Genzo', text: 'Ground does not do that.', speakerFaction: 'player' },
              {
                speaker: 'Kanna',
              ...
              {
                speaker: 'Shigeru',
                text: 'Agreed. Everyone keep off the ash. Kanna, mark where its edge is when we finish, then we deal with Hyodo.',
                speakerFaction: 'player',
              },
            ],
          },
      ...
      effects: [
        {
          ...
          scene: {
            lines: [
              ...
              {
                speaker: 'Shigeru',
                text: 'Captain Hyodo. You are holding a hill fort in a kingdom that no longer exists, against men who have nowhere else to go. You do not have to die here.',
                speakerFaction: 'player',
              },
              {
                speaker: 'Hyodo',
  ...
  supportConversations: [
    {
      ...
      lines: [
        ...
        {
          speaker: 'Shigeru',
          text: 'We are being hunted across our own country, Hina.',
          speakerFaction: 'player',
        },
        {
          speaker: 'Hina',
        ...
        {
          speaker: 'Hina',
          text: 'Leave that to me. I have already made Goro dig a fire pit. He thinks it was his idea.',
          speakerFaction: 'player',
        },
      ],
    ...
    },
    {
      ...
      lines: [
        {
          speaker: 'Goro',
          text: 'Genzo. Straight question. Do you ever miss the other side?',
          speakerFaction: 'player',
        },
        {
          speaker: 'Genzo',
        ...
        { speaker: 'Goro', text: '...Sorry I asked.', speakerFaction: 'player' },
        {
          speaker: 'Genzo',
