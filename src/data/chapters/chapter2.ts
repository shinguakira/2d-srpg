...
export const CHAPTER_2: ChapterData = {
  ...
  prologue: {
    lines: [
      ...
      {
        speaker: 'Kanna',
        text: 'Their banner is Commander Ryuji\u2019s. He took this bridge eleven days ago and has not moved a man since. He will not come out to meet us.',
        speakerFaction: 'player',
      },
      {
        speaker: 'Shigeru',
        text: 'Then we go to him. How do you know his banner, Kanna?',
        speakerFaction: 'player',
      },
      {
        speaker: 'Kanna',
  ...
  epilogue: {
    lines: [
      {
        speaker: 'Kanna',
        text: 'Shigeru. Ryuji was carrying a ward-stone. A shrine ward — the kind that is set into a seal and never, ever leaves it.',
        speakerFaction: 'player',
      },
      ...
      effects: [
        {
          ...
          scene: {
            lines: [
              { speaker: 'Genzo', text: 'I am done.', speakerFaction: 'enemy' },
              { speaker: 'Akira', text: 'It is a trap. Hold the line!', speakerFaction: 'player' },
              {
                speaker: 'Genzo',
                text: 'It is not. Sergeant Genzo, second wall company. Eleven years I have stood a watch post for that man.',
      ...
      effects: [
        {
          ...
          scene: {
            lines: [
              ...
              {
                speaker: 'Shigeru',
                text: 'Kanna, we are in the middle of\u2014',
                speakerFaction: 'player',
              },
              {
                speaker: 'Kanna',
      ...
      effects: [
        {
          ...
          scene: {
            lines: [
              ...
              {
                speaker: 'Shigeru',
                text: 'That is most of the men we are going to have to kill, Genzo.',
                speakerFaction: 'player',
              },
              {
                speaker: 'Genzo',
