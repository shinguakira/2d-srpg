...
| Kanna | (15, 6) | Mage. Rear row. |
| Goro | (13, 5) | Fighter. Left path starter. |
| Hina | (15, 7) | Cleric. Rear row behind Akira. |
| Genzo | (13, 8) | Soldier. Right path starter. |
| Sayo | (15, 5) | Archer. Rear left, covers both paths. |
| Hachi | (13, 9) | Thief. Right flank for chest access. |
| Yuki | (14, 4) | Pegasus Knight. New recruit, left flank. Can fly over mountains. |

## Enemy Forces
| Enemy | Class | Level | Position | AI | Notes |
|-------|-------|-------|----------|-----|-------|
| General Tetsuzan | General | 12 | (1, 7) Throne | Boss | Lance/sword. 50 HP. Very high DEF. Arc 1 final boss. |
| Knight Captain | Knight | 10 | (2, 6) | Escort | Lance. Guards Tetsuzan's left flank. |
| Knight Sentinel | Knight | 10 | (2, 8) | Escort | Lance. Guards Tetsuzan's right flank. |
...
## Objective
- Victory: Seize the throne (Shigeru on Tetsuzan's throne tile after Tetsuzan is defeated)
- Defeat: Shigeru falls, or all player units are defeated

## Key Tiles
| Tile | Position | Effect |
|------|----------|--------|
| Throne | (1, 7) | +3 DEF, +10 Avoid, HP regen. Tetsuzan's seat. |
...
| Chest | (3, 12) | Contains Vulnerary. Hachi can reach via right wall. |
...
| Yuki reaches (11, 2) | Village visit | Obtain Iron Blade. Dialogue about sky anomalies. |
...
## Tactical Notes
- **Yuki's debut**: Flying ignores the mountain edges — she can flank the fortress from the west while the ground team pushes the road. Teaches flying unit versatility.
...
- **Tetsuzan's escort**: The two Knights in Escort AI will not leave Tetsuzan's side. The player must break through both to reach the throne. Magic (Kanna) bypasses their high DEF.
