...
export const CLASSES: Record<string, UnitClass> = {
  lord: {
    ...
    promotesTo: ['great_lord', 'conqueror'],
    weaponTypes: ['sword'],
  },
  cavalier: {
    id: 'cavalier',
  ...
  mage: {
    ...
    promotesTo: ['sage', 'mage_knight'],
    weaponTypes: ['fire', 'thunder', 'wind'],
  },
  fighter: {
    id: 'fighter',
    name: 'Fighter',
  ...
  soldier: {
    ...
    promotesTo: ['general_soldier', 'halberdier'],
    weaponTypes: ['lance'],
  },
  cleric: {
    id: 'cleric',
    ...
    promotesTo: ['bishop', 'valkyrie_cleric'],
    weaponTypes: ['staff'],
  },
  ...
  archer: {
    ...
    promotesTo: ['sniper', 'nomad_trooper'],
    weaponTypes: ['bow'],
  },
  thief: {
    id: 'thief',
  ...
  pegasus_knight: {
    ...
    promotesTo: ['falcon_knight', 'dark_flier'],
    weaponTypes: ['lance'],
    flying: true,
  },
  wyvern_rider: {
  ...
  troubadour: {
    ...
    promotesTo: ['valkyrie_troubadour', 'maid'],
    weaponTypes: ['staff'],
    innateSkills: ['canto'],
    mounted: true,
  },
  ...
  knight: {
    ...
    promotesTo: ['general_knight', 'great_knight_armor'],
    weaponTypes: ['lance'],
    armored: true,
  },
  dancer: {
