...
/**
 * 会話パートの台本。`specs/story/chapters/ch1.md` の第1章「クレハへの道」。
 *
...
export const BOSS_TALK: Script = {
  ...
  lines: [
    ...
    L('ヴァルガ', 'e_boss', 'right', 'できねえ。クロガネが弟の村を押さえてる。それが報酬のもう半分だ。'),
    L(
      'ヴァルガ',
      'e_boss',
      'right',
...
export const ENDING: Script = {
  ...
  lines: [
    ...
    L('ミナ', 'p_mina', 'right', 'ごめんください！こちらが王家の隊ですね？シラトの社から走り通しで来ました！'),
