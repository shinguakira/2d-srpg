...
**Turn 4 — Nadine.** A mounted healer treating a Kurogane soldier mid-battle. Akira
...
**Boss.** Aeryn is beaten out of the air by Elin and takes it professionally, then
...
- **Shigeru × Corwin** — Corwin has served eleven captains; the good ones counted
  their dead by name for about a year and then stopped. Shigeru orders him to say so
  when it starts happening.
- **Mirelle × Nadine** — two healers with different theologies of the same job. *"You
