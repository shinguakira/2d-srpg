    ...
    <g>
      ...
      <g>
        <animateTransform
          ...
          type="translate"
          values="0 0; 0.5 -0.3; 0 0; -0.3 0.2; 0 0"
          dur="2.5s"
      ...
      <g>
        ...
        <path
          d="M10,10 Q10,4 13,3 L15,5 L17,3 Q20,4 22,6 Q22,10 21,11 L20,8 Q16,6 12,8 L11,11 Z"
          fill={c.dark}
        />
...
function MasterSprite({ c, base, glow }: { c: Palette; base: string; glow: string }) {
  ...
  return (
    <g>
      ...
      <polygon
        points="16,0 17.2,3 20,3 17.8,5 18.6,8 16,6.5 13.4,8 14.2,5 12,3 14.8,3"
        fill={glow}
        opacity="0.7"
      />
    </g>
